...
export default function Home() {
	...
	return (
		<div className="flex flex-col gap-4 bg-gradient-to-br from-blue-100 to-blue-iblue400i300 min-h-screen">
			...
			<main className="px-3 max-w-7xl mx-auto flex flex-col gap-2 w-full pb-10 pt-4">
					...
					<>
						<section className="space-y-4">
							<div className="text-2xl md:text-4xl font-bold flex justify-center items-center">
								<h1 className="text-blue-700 drop-shadow-lg">
									WeatherWise{" "}
							...
							<div className="w-full h-1 bg-gradient-to-r from-blue-400 to-blue-700 rounded-full shadow-sm"></div>
							<div className="space-y-2">
								...
								<Container className="gap-10 px-6 items-center bg-white backdrop-blur-sm rounded-xl shadow-sm">
							...
							<div className="flex gap-4">
								<Container className="w-fit bg-white backdrop-blur-sm rounded-xl shadow-sm justify-center flex-col px-4 items-center">
				...
				<div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mt-3">
				...
				<div className="flex justify-center items-center mb-6">
					...
					<div className="w-full max-w-sm mx-1 md:mx-4">
						<DevCard
